...
We will use the predicate \code{on}/$3$ to capture the state of the Hanoi puzzle at each time point.
...
The output of the solver (\clingo{} in this case) will look something like that:
