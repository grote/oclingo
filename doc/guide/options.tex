...
\begin{newstuff}
	\begin{itemize}
		\item stats is not yet implemented
		\item verbose takes level now
		\item debug corresponds to verbose=3
		\item aspils is gone
		\item bindersplit is gone (not worth implementing, can be done in preprocessor)
	\end{itemize}
\end{newstuff}
...
\begin{newstuff}
	\begin{itemize}
		\item the subsubsections below are probably outdated, benny?
	\end{itemize}
\end{newstuff}
