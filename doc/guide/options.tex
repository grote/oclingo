...
\item[\code{--verbose[=n],-V=[n]}]~\\
Print additional (progress) information during computation.
Verbosity level one and two is reserved for clasp only.
...
(These facts can then be used to, i.e., write a meta-interpreter.)
...
For a brief overview about fine-tuning see \cite{gekasc09b}.
