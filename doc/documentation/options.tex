...
Read from file \code{\textit{filename}} (rather than from standard input).
...
Use seed~\code{\textit{n}} for random number generator.
...
Together with \code{--lookback=yes}, \code{--restarts=100,1.5} lets \clasp\ apply a geometric
restart policy.
