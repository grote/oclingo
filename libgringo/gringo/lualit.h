...
class LuaLit : public Lit, public Matchable
{
public:
	...
	Lit::Score score(Grounder *, VarSet &) { return Lit::Score(Lit::NON_RECURSIVE,0); }
	~LuaLit();
private:
...
inline int LuaLit::index() const { return luaIndex_; }
